...
export async function getCowProtocolSellRates({
  ...
  return {
    ...
    srcDecimals,
    destToken,
    destSpotAmount: orderBookQuote.quoteResults.amountsAndCosts.beforeNetworkCosts.buyAmount.toString(),
    destSpotUSD: destSpotInUsd.toString(),
    afterFeesUSD: destAmountInUsd.toString(),
    afterFeesAmount: orderBookQuote.quoteResults.amountsAndCosts.afterPartnerFees.buyAmount.toString(),
    destDecimals,
    orderBookQuote,
